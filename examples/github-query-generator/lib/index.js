...
exports.getGitHubQueryGenerator = exports.GitHubQueryGenerator = void 0;
const fs = require("fs");
...
exports.GitHubQueryGenerator = GitHubQueryGenerator;
function getGitHubQueryGenerator(gitHubAccessToken) {
    return new Promise((resolve, reject) => {
        const gitHubSchemaStr = fs.readFileSync(path.resolve(__dirname, '../fixtures/github.graphql'), 'utf8');
